...
const categories = [
    {
      title: "YouTube Strategy & Planning",
    ...
    {
      title: "Video SEO & Channel Optimization",
      desc: "We optimize your channel, video titles, descriptions, and tags to increase rankings on both YouTube and Google search.",
    },
    {
      title: "YouTube Ads",
      desc: "Drive high-quality views and conversions with targeted YouTube ad campaigns designed for maximum ROI.",
    },
    {
      title: "Content Creation & Management",
      desc: "From ideation to production, we create engaging videos that capture attention and deliver your message effectively.",
    },
  ];
