  ...
  const categories = [
    {
      ...
      desc: "Plan and execute email campaigns tailored to your audience and business goals.",
    },
    {
      title: "Automation Workflows",
      desc: "Create automated sequences for onboarding, re-engagement, and lead nurturing.",
    },
    {
      title: "Content & Design",
      desc: "Craft compelling copy and responsive designs that boost engagement and conversions.",
    },
    {
      title: "Analytics & Optimization",
      desc: "Track performance, analyze data, and refine campaigns for maximum ROI.",
    },
  ];
