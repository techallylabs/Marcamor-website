  ...
  const categories = [
    {
      ...
      desc: "We define how your brand should be perceived in the market to create a strong and distinct identity.",
    },
    {
      title: "Brand Messaging & Voice",
      desc: "From taglines to tone, we craft consistent messaging that reflects your brand’s values and connects with your audience.",
    },
    {
      title: "Competitive Analysis",
      desc: "We analyze competitors and market trends to position your brand for maximum visibility and differentiation.",
    },
    {
      title: "Brand Guidelines",
      desc: "We create detailed brand guidelines — including colors, typography, and tone — to maintain consistency across all platforms.",
    },
  ];
