  ...
  const categories = [
    {
      ...
      desc: "Professional, visually engaging presentations that effectively convey your message with clarity, style, impact, and strategic visual storytelling.",
    },
    {
      title: "Annual Reports & Brochures",
      desc: "Comprehensive and well-structured designs that combine strong visuals with data storytelling.",
    },
    {
      title: "Business Documents & Templates",
      desc: "Custom-designed letterheads, proposals, and templates that maintain consistent brand tone and identity.",
    },
    {
      title: "Internal Communication Materials",
      desc: "Designs that strengthen employee engagement, such as newsletters, handbooks, and training manuals.",
    },
  ];
