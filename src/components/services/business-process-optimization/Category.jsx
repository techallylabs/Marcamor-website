  ...
  const categories = [
    {
      ...
      desc: "We evaluate your current processes to identify inefficiencies and redesign them for improved productivity.",
    },
    {
      title: "Automation & Technology Integration",
      desc: "From CRM systems to AI-driven tools, we integrate smart technologies that save time and reduce errors.",
    },
    {
      title: "Operational Strategy & KPIs",
      desc: "We build clear performance metrics and strategies to monitor, measure, and enhance operational success.",
    },
    {
      title: "Change Management & Training",
      desc: "Support and training programs to ensure smooth implementation and team adoption of new processes.",
    },
  ];
