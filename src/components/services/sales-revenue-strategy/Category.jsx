  ...
  const categories = [
    {
      ...
      desc: "We design and optimize sales funnels to guide customers seamlessly from awareness to conversion.",
    },
    {
      title: "Revenue Growth Planning",
      desc: "Tailored strategies that focus on pricing models, recurring revenue streams, and market expansion.",
    },
    {
      title: "Lead Generation & Nurturing",
      desc: "End-to-end solutions to attract, qualify, and convert high-quality leads into loyal customers.",
    },
    {
      title: "Sales Team Training & Enablement",
      desc: "We develop sales playbooks, training modules, and tools to empower teams and improve closing rates.",
    },
  ];
