  ...
  const categories = [
    {
      ...
      desc: "Tailored e-commerce websites built to match your brand identity and meet your business needs.",
    },
    {
      title: "Platform Expertise",
      desc: "Development on platforms like Shopify, WooCommerce, Magento, and custom-built solutions.",
    },
    {
      title: "Secure Payment Integration",
      desc: "Reliable and hassle-free payment gateways to ensure smooth transactions.",
    },
    {
      title: "Conversion-Focused Design",
      desc: "Intuitive layouts, product pages, and checkout flows designed to drive sales.",
    },
  ];
